...
function first() {
    ...
    buttonNew.addEventListener("click", insert, false);
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    //creates a person
                    var oPersona = new Persona(data[i].id, data[i].nombre, data[i].apellidos, data[i].direccion, data[i].tlf, data[i].fotoURL, data[i].fechaNac, data[i].idDepartamento)
