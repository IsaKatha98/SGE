...
function pedirMarcas() {
    ...
    miLLamada.open("GET", "http://localhost:5053/api/marcas");
...
function pedirModelos() {
    ...
    getModelos.open("GET", "http://localhost:5053/api/modelos/byMarca/" + idMarca);
...
function guardarCambios() {
    ...
    for (var i = 0; i < modelosModificado.length; i++) {
        ...
        if (modelosModificado[i].value != listaModelos[i].precio) {
            ...
            miLLamada.open("PUT", "http://localhost:5053/api/modelos/" + modelosModificado[i].id);
